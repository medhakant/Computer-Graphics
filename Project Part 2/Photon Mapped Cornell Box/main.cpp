...
void cornell_box_renderer(){
   ...
   sphere s2(vec3(-0.7,-1.5,0.6),vec3(0,1,0),0.5,90,color(255,255,255),0.1,0.9,0.05,0.95,1.51);
   cornell_box.addSphere(&s2);
   sphere s3(vec3(0.2,-1.5,0.1),vec3(0,1,0),0.5,90,color(255,255,255),0.1,0.9,0.05,0.95,1.51);
