...
void cornell_box_renderer(){
   ...
   sphere s2(vec3(-0.3,-1.5,1),vec3(0,1,0),0.5,90,color(255,255,255),0.1,0.9,0.1,0.9,1.33);
   cornell_box.addSphere(&s2);
   sphere s3(vec3(0.6,-1.5,0.5),vec3(0,1,0),0.5,90,color(255,255,255),0.1,0.9,0.1,0.9,1.33);
