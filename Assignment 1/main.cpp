...
int main( int argc, char* args[] )
{
   ...
   snowman.addLight(&l1);
   light l2 = light(vec3(1.95,-1.75,-1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l2);
   light l3 = light(vec3(1.95,-1.5,-1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l3);
   light l4 = light(vec3(1.95,-1.25,-1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l4);

   light l5 = light(vec3(-1.95,-2,-1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l5);
   light l6 = light(vec3(-1.95,-1.75,-1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l6);
   light l7 = light(vec3(-1.95,-1.50, -1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l7);
   light l8 = light(vec3(-1.95,-1.25, -1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l8);

   light l9 = light(vec3(-1.95,-2, 1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l9);
   light l10 = light(vec3(-1.95,-1.75,1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l10);
   light l11 = light(vec3(-1.95,-1.50, 1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l11);
   light l12 = light(vec3(-1.95,-1.25, 1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   ...
   light l14 = light(vec3(1.95,-1.75,1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l14);
   light l15 = light(vec3(1.95,-1.50, 1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
   snowman.addLight(&l15);
   light l16 = light(vec3(1.95,-1.25, 1.95),vec3(0,1,0),1/25.0,0.25,color(255,255,255),0.7,0.3,0.9,0,-1);
